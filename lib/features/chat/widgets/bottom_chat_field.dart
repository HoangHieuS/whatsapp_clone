...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  Widget build(BuildContext context) {
    final msgReply = ref.watch(msgReplyProvider);
    final isShowMsgReply = msgReply != null;
    return Column(
      children: [
        isShowMsgReply ? const MessageReplyPreview() : const SizedBox(),
        Row(
          children: [
            Expanded(
              child: TextFormField(
            ...
            ? SizedBox(
                ...
                child: EmojiPicker(
                  onEmojiSelected: ((category, emoji) {
                    setState(() {
                      _messController.text += emoji.emoji;
                    });
